    ...
    <section className="relative py-12 lg:py-14  bg-white overflow-hidden">
      ...
      <div className="max-w-[1280px] mx-auto px-6 lg:px-8">
        <AnimatedSection direction="up" className="text-center mb-16">
          <p className="overline mb-3">Our Track Record</p>
          <h2
          ...
          >
            Decades of
            <span
              className="text-violet-gradient ml-3"
              style={{}}
            >
          ...
          {ACHIEVEMENTS.map((achievement) => {
            ...
            return (
              <StaggerItem key={achievement.id} direction="up">
                <div className="group bg-white rounded-2xl border border-border shadow-card p-10 flex flex-col items-center text-center hover:shadow-card-hover hover:-translate-y-1.5 transition-all duration-500">
                  <p
                    className="font-heading font-bold text-violet-gradient leading-none mb-3"
